...
+'<div id="annContrastHint" class="adm-ad-contrast"></div><div class="adm-ad-presets"><span style="font-size:11px;color:#65757A;width:100%;display:block;margin-bottom:2px;">Design Palettes:</span><button type="button" data-ad-preset="emerald">Emerald</button><button type="button" data-ad-preset="ocean">Ocean</button><button type="button" data-ad-preset="royal">Royal</button><button type="button" data-ad-preset="sunset">Sunset</button><button type="button" data-ad-preset="mono">Mono</button><button type="button" data-ad-preset="gold">Gold Luxury</button><button type="button" data-ad-preset="rose">Rose</button><button type="button" data-ad-preset="neon">Neon</button></div></fieldset>'
+'<div class="adm-ad-two"><div><label>CTA Button Label</label><select id="annCta" onchange="window.skhRenderAdminAdPreview()"><option value="">No CTA</option><option>Tazama Zaidi</option><option>Angalia Sasa</option><option>Jifunze Zaidi</option><option>Tembelea</option><option>Nunua Sasa</option><option>Wasiliana Nasi</option><option>Pata Ofa Hii</option><option>Agiza Hapa</option><option>Piga Simu</option></select></div><div><label>CTA URL (HTTPS link au #anchor)</label><input id="annLink" type="url" oninput="window.skhRenderAdminAdPreview()" placeholder="https://..."></div></div>'
+'<div class="adm-ad-two"><div><label>CTA Button Style</label><select id="annCtaStyle" onchange="window.skhRenderAdminAdPreview()"><option value="solid">Solid Gradient Pill</option><option value="outline">Outline Border</option><option value="glass">Glassmorphic Glow</option><option value="shine">Vibrant Shine</option></select></div><div><label>CTA Button Icon</label><select id="annCtaIcon" onchange="window.skhRenderAdminAdPreview()"><option value="arrow">Arrow Right (→)</option><option value="cart">Shopping Cart (🛒)</option><option value="phone">Phone Call (📞)</option><option value="whatsapp">WhatsApp (💬)</option><option value="star">Star Badge (⭐)</option></select></div></div>'
...
window.skhAdApplyPreset=function(name){const presets={emerald:['#0E7A5F','#18A982','#FFFFFF','#FFFFFF',42],ocean:['#075E73','#2697B8','#FFFFFF','#FFFFFF',48],royal:['#343A8F','#7559C7','#FFFFFF','#FFFFFF',50],sunset:['#A83E27','#E49A36','#FFFFFF','#FFFDFC',55],mono:['#1F2937','#6B7280','#FFFFFF','#FFFFFF',36],gold:['#1E2229','#D4AF37','#FFFFFF','#111827',85],rose:['#881337','#E11D48','#FFFFFF','#FFF1F2',50],neon:['#064E3B','#10B981','#A7F3D0','#064E3B',60]},p=presets[name]||presets.emerald,ids=['annPrimaryColor','annAccentColor','annTextColor','annSurfaceColor','annFrameOpacity'];ids.forEach((id,i)=>{const el=document.getElementById(id);if(el)el.value=p[i]});window.skhAdOpacityChanged(p[4],false);window.skhRenderAdminAdPreview();};
