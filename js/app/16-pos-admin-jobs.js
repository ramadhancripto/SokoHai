...
window.skhAdFormHtml=function(){return '<section class="adm-ad-form"><div class="adm-ad-form-head"><h3 id="annFormTitle">Create Advertisement</h3><button class="adm-ad-btn" onclick="document.getElementById(\'announcementFormModal\').style.display=\'none\'">Close</button></div><div class="adm-ad-form-grid"><div class="adm-ad-fields">'
+'<label>Step 1 — Creative Type</label><select id="annCreativeType" onchange="window.skhRenderAdminAdPreview()"><option value="image">Image</option><option value="image_text">Image + Text</option><option value="graphic">Graphic Advertisement</option><option value="video">Video</option><option value="video_text">Video + Text</option><option value="image_audio">Image + Audio</option><option value="video_audio">Video + Audio</option><option value="solid_text">Solid Background + Text</option></select>'
+'<label>Step 2 — Brand / Name</label><input id="annBrand" maxlength="80" oninput="window.skhRenderAdminAdPreview()" placeholder="Brand or campaign name">'
+'<label>Headline</label><input id="annHeadline" maxlength="120" oninput="window.skhRenderAdminAdPreview()" placeholder="Clear campaign headline">'
+'<label>Short description</label><textarea id="annText" rows="3" maxlength="240" oninput="window.skhRenderAdminAdPreview()" placeholder="Short promotional message"></textarea>'
+'<fieldset class="adm-ad-theme"><legend>Graphic Design Colors</legend><p>Chagua rangi za brand. Preview na tangazo la Home vitatumia rangi hizi hizi.</p><div class="adm-ad-color-grid"><label><span>Primary</span><input id="annPrimaryColor" type="color" value="#0E7A5F" oninput="window.skhRenderAdminAdPreview()"></label><label><span>Accent</span><input id="annAccentColor" type="color" value="#167A91" oninput="window.skhRenderAdminAdPreview()"></label><label><span>Headline/Text</span><input id="annTextColor" type="color" value="#FFFFFF" oninput="window.skhRenderAdminAdPreview()"></label><label><span>Card surface</span><input id="annSurfaceColor" type="color" value="#FFFFFF" oninput="window.skhRenderAdminAdPreview()"></label></div><label class="adm-ad-opacity"><span>Frame opacity <b id="annFrameOpacityValue">42%</b></span><input id="annFrameOpacity" type="range" min="8" max="100" step="1" value="42" oninput="window.skhAdOpacityChanged(this.value)"></label><div id="annContrastHint" class="adm-ad-contrast"></div><div class="adm-ad-presets"><button type="button" data-ad-preset="emerald">Emerald</button><button type="button" data-ad-preset="ocean">Ocean</button><button type="button" data-ad-preset="royal">Royal</button><button type="button" data-ad-preset="sunset">Sunset</button><button type="button" data-ad-preset="mono">Mono</button></div></fieldset>'
+'<div class="adm-ad-two"><div><label>CTA Label</label><select id="annCta" onchange="window.skhRenderAdminAdPreview()"><option value="">No CTA</option><option>Tazama Zaidi</option><option>Angalia Sasa</option><option>Jifunze Zaidi</option><option>Tembelea</option><option>Nunua</option><option>Wasiliana</option></select></div><div><label>CTA URL</label><input id="annLink" type="url" oninput="window.skhRenderAdminAdPreview()" placeholder="https://..."></div></div>'
+'<label>Image / Graphic / Poster URL</label><div class="adm-ad-upload"><input id="annImage" type="url" oninput="window.skhRenderAdminAdPreview()" placeholder="HTTPS media URL"><input id="annImageFile" type="file" accept="image/*" hidden onchange="window.skhAdminAdUpload(\'image\',this)"><button class="adm-ad-btn" onclick="document.getElementById(\'annImageFile\').click()">Upload</button><button class="adm-ad-btn" onclick="window.skhOpenAdminMediaLibrary(\'annImage\')">Library</button></div>'
+'<label>Video URL</label><div class="adm-ad-upload"><input id="annVideo" type="url" oninput="window.skhRenderAdminAdPreview()" placeholder="HTTPS video URL"><input id="annVideoFile" type="file" accept="video/*" hidden onchange="window.skhAdminAdUpload(\'video\',this)"><button class="adm-ad-btn" onclick="document.getElementById(\'annVideoFile\').click()">Upload</button><button class="adm-ad-btn" onclick="window.skhOpenAdminMediaLibrary(\'annVideo\')">Library</button></div>'
+'<label>Audio URL</label><div class="adm-ad-upload"><input id="annAudio" type="url" oninput="window.skhRenderAdminAdPreview()" placeholder="HTTPS audio URL"><input id="annAudioFile" type="file" accept="audio/*" hidden onchange="window.skhAdminAdUpload(\'audio\',this)"><button class="adm-ad-btn" onclick="document.getElementById(\'annAudioFile\').click()">Upload</button><button class="adm-ad-btn" onclick="window.skhOpenAdminMediaLibrary(\'annAudio\')">Library</button></div>'
+'<label>Logo URL</label><div class="adm-ad-upload"><input id="annLogo" type="url" oninput="window.skhRenderAdminAdPreview()" placeholder="HTTPS logo URL"><input id="annLogoFile" type="file" accept="image/*" hidden onchange="window.skhAdminAdUpload(\'logo\',this)"><button class="adm-ad-btn" onclick="document.getElementById(\'annLogoFile\').click()">Upload</button><button class="adm-ad-btn" onclick="window.skhOpenAdminMediaLibrary(\'annLogo\')">Library</button></div>'
+'<div class="adm-ad-two"><div><label>Start date/time</label><input id="annStartAt" type="datetime-local"></div><div><label>End date/time</label><input id="annEndAt" type="datetime-local"></div></div><div class="adm-ad-two"><div><label>Priority</label><input id="annPriority" type="number" min="0" max="999" value="0"></div><div><label>Save state</label><select id="annStatus" onchange="window.skhAdStatusChanged()"><option value="published">Publish / Schedule</option><option value="draft">Draft</option></select></div></div>'
+'</div><aside class="adm-ad-preview-wrap"><h4>Step 3 — Home Preview</h4><div id="annPreview" class="adm-ad-preview"></div><label style="display:flex;align-items:center;gap:8px;margin-top:12px;font-size:12px;color:#526962"><input id="annPreviewConfirmed" type="checkbox"> Nimekagua preview na kuthibitisha muonekano</label><button type="button" class="adm-ad-btn adm-ad-advanced" onclick="window.skhOpenAdvancedFromLegacy()">Advanced Design (Optional)</button><p class="adm-ad-advanced-note">Tumia tu ikiwa unahitaji layers, fonts, templates au export. Fomu hii rahisi bado ndiyo workflow kuu.</p></aside></div><div class="adm-ad-submit"><button class="adm-ad-btn" onclick="document.getElementById(\'announcementFormModal\').style.display=\'none\'">Cancel</button><button class="adm-ad-btn primary" id="btnSubmitAnnouncement" onclick="window.submitAnnouncementForm()">Save Advertisement</button></div></section>';};

window.openAnnouncementFormModal=function(editId){if(!((window.SOKOHAI_CLAIMS&&window.SOKOHAI_CLAIMS.isAdmin)||(skh.currentUser&&skh.currentUser.email===skh.MY_ADMIN_EMAIL))){alert('Admin authorization required.');return;}window.__editingAnnouncementId=editId||null;const existing=editId?(window.__sokohaiAnnouncementsCache||[]).find(a=>a.id===editId):null;let modal=document.getElementById('announcementFormModal');if(!modal){modal=document.createElement('div');modal.id='announcementFormModal';modal.className='overlay-menu';modal.style.cssText='z-index:9999;display:none;';document.body.appendChild(modal);}modal.innerHTML=window.skhAdFormHtml();const set=(id,v)=>{const e=document.getElementById(id);if(e)e.value=v||'';};set('annCreativeType',existing?.creativeType||'image_text');set('annBrand',existing?.brandName||'');set('annHeadline',existing?.headline||existing?.title||'');set('annText',existing?.description||existing?.text||'');set('annCta',existing?.ctaLabel||'');set('annLink',existing?.link||'');set('annImage',existing?.image||existing?.imageUrl||'');set('annVideo',existing?.videoUrl||'');set('annAudio',existing?.audioUrl||'');set('annLogo',existing?.logoUrl||'');set('annPrimaryColor',existing?.primaryColor||'#0E7A5F');set('annAccentColor',existing?.accentColor||'#167A91');set('annTextColor',existing?.textColor||'#FFFFFF');set('annSurfaceColor',existing?.surfaceColor||'#FFFFFF');set('annFrameOpacity',Math.round((existing?.frameOpacity??0.42)*100));set('annStartAt',existing?.startAt?existing.startAt.slice(0,16):'');set('annEndAt',existing?.endAt?existing.endAt.slice(0,16):'');set('annPriority',existing?.priority||0);set('annStatus',existing?(existing.status||((existing.active===false)?'draft':'published')):'published');document.getElementById('annFormTitle').textContent=existing?'Edit Advertisement':'Create Advertisement';modal.style.display='flex';window.skhRenderAdminAdPreview();window.skhAdStatusChanged();window.skhAdOpacityChanged(document.getElementById('annFrameOpacity')?.value||42,false);};

window.skhAdFormData=function(){const v=id=>(document.getElementById(id)?.value||'').trim();return{creativeType:v('annCreativeType'),brandName:v('annBrand'),headline:v('annHeadline'),description:v('annText'),text:v('annText'),ctaLabel:v('annCta'),link:v('annLink'),image:v('annImage'),imageUrl:v('annImage'),videoUrl:v('annVideo'),audioUrl:v('annAudio'),logoUrl:v('annLogo'),primaryColor:v('annPrimaryColor')||'#0E7A5F',accentColor:v('annAccentColor')||'#167A91',textColor:v('annTextColor')||'#FFFFFF',surfaceColor:v('annSurfaceColor')||'#FFFFFF',frameOpacity:Math.max(.08,Math.min(1,(Number(v('annFrameOpacity'))||42)/100)),startAt:v('annStartAt')?new Date(v('annStartAt')).toISOString():'',endAt:v('annEndAt')?new Date(v('annEndAt')).toISOString():'',priority:Math.max(0,Number(v('annPriority'))||0),status:v('annStatus')||'draft',active:v('annStatus')==='published',archived:false};};
...
window.skhAdApplyPreset=function(name){const presets={emerald:['#0E7A5F','#18A982','#FFFFFF','#FFFFFF',42],ocean:['#075E73','#2697B8','#FFFFFF','#FFFFFF',48],royal:['#343A8F','#7559C7','#FFFFFF','#FFFFFF',50],sunset:['#A83E27','#E49A36','#FFFFFF','#FFFDFC',55],mono:['#1F2937','#6B7280','#FFFFFF','#FFFFFF',36]},p=presets[name]||presets.emerald,ids=['annPrimaryColor','annAccentColor','annTextColor','annSurfaceColor','annFrameOpacity'];ids.forEach((id,i)=>{const el=document.getElementById(id);if(el)el.value=p[i]});window.skhAdOpacityChanged(p[4],false);window.skhRenderAdminAdPreview();};
