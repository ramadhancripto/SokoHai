...
window.toggleSokoPayTab = function(tab) {
    ...
    tabButtons.forEach(btn => {
        ...
        if (onclickAttr.includes(`'${tab}'`)) {
            ...
            btn.style.background = '#EAF8F2';
            btn.style.color = '#17604E';
        } else {
            btn.classList.remove('active');
            btn.style.background = 'transparent';
            btn.style.color = '#65757A';
        }
    });
...
(function injectSokoHaiAccountMenuCSS(){
    ...
    .skh-menu-head { background:#F1FBF7; color:#18352D; padding:18px 16px; border-bottom:1px solid #D9EEE5; }
    .skh-menu-top { display:flex; justify-content:space-between; align-items:center; gap:10px; margin-bottom:14px; }
    .skh-menu-top b { font-size:17px; letter-spacing:.4px; color:#17604E; }
    .skh-menu-close { width:36px; height:36px; border:1px solid #CCEBDD; border-radius:12px; background:#fff; color:#17604E; font-weight:950; cursor:pointer; }
    .skh-user-card { display:flex; align-items:center; gap:12px; background:#fff; border:1px solid #D9EEE5; border-radius:16px; padding:12px; }
    .skh-user-card img { width:52px; height:52px; border-radius:50%; object-fit:cover; background:#EAF8F2; border:2px solid #B9DFCF; flex-shrink:0; }
    .skh-user-card b { display:block; font-size:14px; color:#18352D; white-space:nowrap; overflow:hidden; text-overflow:ellipsis; max-width:210px; }
    .skh-user-card small { color:#65757A; font-size:12.5px; }
    .skh-menu-scroll { flex:1; overflow-y:auto; padding:10px 10px 18px; background:#fff; }
    ...
    .skh-menu-item:hover { background:#F1F8F5; border-color:#CCEBDD; }
    ...
    .skh-settings-head { background:#F1FBF7; color:#18352D; padding:16px; border-bottom:1px solid #D9EEE5; display:flex; justify-content:space-between; align-items:center; gap:10px; }
    .skh-settings-head b { font-size:16px; color:#17604E; }
    .skh-settings-body { padding:16px; overflow-y:auto; background:#fff; }
    ...
    .skh-action-btn { width:100%; min-height:42px; border:none; border-radius:12px; background:#18A982; color:white; font-weight:950; margin-top:10px; cursor:pointer; }
