...
export function makeLayer(type,patch={}){
  const common={
    id:uid(),type,x:120,y:120,width:620,height:type==='text'?150:420,
    ...
    videoMeta:{autoplay:true,muted:true,loop:true,trimStart:0,trimEnd:0,duration:0,controls:false,...(patch.videoMeta||{})},
    animation:{
